    ...
    <div class="controls-section">
      ...
      <div class="time-section">
        <div class="time-group">
          <label
            class="time-label"
            style="display: flex; justify-content: center; align-items: center; background-color: {scheduleType !==
            'Custom Time'
              ? 'var(--grey-dark)'
              : 'var(--blue-dark)'}; width: 100%;
          padding: 4px; color: white; border-radius: 3px;
...
<style>
  ...
  .announcement-container {
    ...
    min-height: 100vh;
    padding: 20px;
    background: url("src/assets/img/home.webp") no-repeat;
