...
app.post("/api/book-ticket", async (req, res) => {
  try {
    ...
    try {
      ...
      console.error("❌ Failed to parse sflightoffer:", req.body.sflightoffer);
      return res.status(400).json({ message: "Invalid flight offer format" });
    }
    const ticketData = {
      ticketNumber,
    ...
    console.log("Ticket Data Before Saving:");
    console.log(JSON.stringify(ticketData, null, 2));
    console.log("Final ticketData.flightOffer:", ticketData.flightOffer);
