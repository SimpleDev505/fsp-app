    ...
    <div class="boarding-cnt" bind:this={boardingpass_cnt}>
      ...
      <div class="ticket-search">
        ...
        <span
          ...
          style="font-size: 20px; position: relative; margin: 20px; padding: 0;"
        >
          search
        </span>
        <button
          style="background-color: white; background-color: var(--blue-dark); color: white; margin: -15px;
          display: flex; justify-content: flex-start; align-items: center; width: fit-content; height: fit-content;"
          class="refresh-btn"
