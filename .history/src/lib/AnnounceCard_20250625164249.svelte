  ...
  function handleAnnounce() {
    ...
    if (loggeddata && loggeddata.username) {
      ...
      if (
        ...
        ann_err = "Fill The Required Data , Before announcing Message!";
        setTimeout(() => {
          ann_err = "";
        }, 2500);
        return;
...
<div class="announcement-container">
  <div class="announcement-card">
    ...
    >
      {#if ann_err}
        <span
          style="font-size: var(--font-sm); color: var(--red); width: fit-content; height: fit-content; padding: 5px; background-color: rgba(255, 0, 0, 0.1);
          border-radius: 5px; white-space: nowrap;
          border-left: 5px solid var(--red);">{ann_err}</span
        >
      {/if}
      <button
...
<style>
  .announcement-container {
    ...
    min-height: 100vh;
    padding: 20px;
    background: url("src/assets/img/home.png");
