<script lang="ts">
  ...
  let discount = $derived(
    parseInt($SelectedFlight?.price.base ?? "1") >
      parseInt($SelectedFlight?.price.total ?? "1")
      ? Math.round(
          ((parseInt($SelectedFlight?.price.base ?? "1") -
            parseInt($SelectedFlight?.price.total ?? "1")) /
            parseInt($SelectedFlight?.price.base ?? "1")) *
              ...
              <div class="details" style="position: relative;">
                  ...
                  <div class="line" style="position: relative;">
                    ...
                    <span
                      ...
                      ><del style="position: relative;" class="old"
                        >₹{$SelectedFlight?.price.base}</del
                      >
                      <span class="new" style="position: relative;"
                        >₹{$SelectedFlight?.price.total}</span
                      ></span
                    >
                  </div>
                  <div class="line" style="position: relative;">
                    ...
                    <span class="discount" style="position: relative;"
                      >{#if $SelectedFlight}
                        ...
                        $SelectedFlight?.price.total
                          ? Math.round(
                              ((parseInt($SelectedFlight?.price.base) -
                                parseInt($SelectedFlight?.price.total)) /
                                parseInt($SelectedFlight?.price.base)) *
                                100
                            )
                          : 0}
                ...
                <div class="coupons" style="position: relative;">
                  ...
                  <input
                    ...
                    bind:value={coupon}
                  />
                  <button style="position: relative;" class="apply"
                    >Apply</button
                  >
                </div>
              </div>
...
<style>
  ...
  .methods .material-symbols-outlined {
    font-size: 18px;
  }
