<script lang="ts">
  ...
  function sidebarhandle(name: string) {
    document.getElementById(navselected)?.classList.remove("sidebar-selected");
    const target = document.getElementById(name);
    if (target) {
      target.classList += " sidebar-selected";
    }
  }
</script>
  ...
  <aside class="sidebar">
    <button
      ...
      onclick={() => {
        ...
        sidebarhandle("dash-btn");
        navselected = "dash-btn";
      }}>DashBoard</button
    >
    <button
      id="board-btn"
      onclick={() => {
        activeSection.set("boarding");
        sidebarhandle("board-btn");
        navselected = "board-btn";
      }}>Boarding Pass</button
    >
    <button
      id="ann-btn"
      onclick={() => {
        activeSection.set("announcements");
        sidebarhandle("ann-btn");
        navselected = "ann-btn";
    ...
    <button
      id="sch-btn"
      onclick={() => {
        activeSection.set("scheduling");
        sidebarhandle("sch-btn");
        navselected = "sch-btn";
      }}>Scheduling</button
    >
  </aside>
