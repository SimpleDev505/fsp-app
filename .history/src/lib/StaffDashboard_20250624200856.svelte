...
<div class="dashboard">
  <aside class="sidebar">
    <button
      ...
      onclick={() => activeSection.set("dashboard")}>DashBoard</button
    >
    <button
      class={$activeSection === "boarding" ? "sidebar-selected" : ""}
      onclick={() => activeSection.set("boarding")}>Boarding Pass</button
    >
    <button
      class={$activeSection === "announcements" ? "sidebar-selected" : ""}
      onclick={() => activeSection.set("announcements")}>Announcements</button
    >
    <button
      class={$activeSection === "scheduling" ? "sidebar-selected" : ""}
      onclick={() => activeSection.set("scheduling")}>Scheduling</button
    >
  </aside>
