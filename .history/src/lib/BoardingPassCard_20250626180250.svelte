<script lang="ts">
  ...
  import { currentTicket, type TicketData } from "./Store/ticket";
...
<div class="boarding-cnt-wrap">
  <div class="boarding-cnt">
    <div class="ticket-search">
      <input placeholder="Ticket Number..." type="text" />
    ...
    <div class="ticket-detail">
      ...
      <span>PassengerName {ticketdetail?.passengers[0]}</span>
      ...
      >
        ...
        <span>Flight Hrs {ticketdetail?.flight.duration}</span>
        <span
          style="display: flex; flex-direction: row; justify-content: flex-start; align-items: center;
          padding: 0;"
        >
      ...
      <span>Booking Date {ticketdetail?.bookingDate}</span>
      <span>Status</span>
    </div>
  </div>
  <!-- Column 2 -->
