...
export const contactEntries: ContactFormData[] = [];

export function saveContact(data: ContactFormData) {
    contactEntries.push(data);
    console.log("Saved Contact:", data);
    console.log("All Entries:", contactEntries);
}
