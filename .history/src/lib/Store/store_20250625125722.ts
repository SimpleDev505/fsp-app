...
import type { FlightOffer, FlightSearchResponse } from "./search.ts";

//PAGES

export const CurrentAppPage = writable<
  "LOGIN" | "HOME" | "ABOUT" | "CONTACT" | "STAFF DASHBOARD" | "ADMIN DASHBOARD"
>("LOGIN");
...
export const FlightSearchResults = writable<FlightSearchResponse | null>(null);
export const ExtraFiltered_Results = writable<FlightSearchResponse | null>(
  null
);
...
export const CurrentNav = writable<String>("home-link");
// const options = {
//   method: "GET",
