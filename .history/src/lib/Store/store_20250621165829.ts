...
export interface SelectedFlightDetail {
    flightId: string;
    airlineCode: string;
    airlineName?: string; // Optional if carrier mapping available
    flightNumber: string;
    aircraftCode: string;
    ...
    bookingDate: string; //Date When Flight Booked
}
export const SelectedFlight = writable<SelectedFlightDetail>();
// CONFIG
//Footer - Links
