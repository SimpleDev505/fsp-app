        ...
        {#each $pastFlightsData as pflight}
          <div class="pflight">
            ...
            >
              <span
                class="material-symbols-outlined"
                style="color: var(--blue-dark); outline: none;
                font-size: 32px;
                width: fit-content;"
              >
                airplane_ticket
              </span>
              <span style="font-size: 10px; width: fit-content;"
                ><span
                  class="material-symbols-outlined"
                ...
                >
                  groups_3
                </span>{pflight.passengers.length}</span
              >
              <span style="font-size: 10px;">{pflight.bookingDate}</span>
              <span style="font-size: 10px;">{pflight.ticketNumber}</span>
              <span style="font-size: 10px;">{pflight.price.total}</span>
            </div>
          </div>
        {/each}
      </div>
