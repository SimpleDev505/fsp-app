<script lang="ts">
  ...
  const profilePhoto = writable<string | null>(null);
      ...
      <div class="profile-avatar" style="position: relative;">
        {#if $profilePhoto}
          ...
          <div
            ...
            style="display: flex; justify-content: center; align-items: center; background-color: transparent; outline: 3px solid var(--blue-dark); position: absolute;"
          >
        ...
        {:else}
          <div
            class="avatar-placeholder"
            style="background-color: transparent; outline: 3px solid var(--blue-dark); position: absolute;"
          >
            <span class="material-symbols-outlined"> close_small </span>
          </div>
