    ...
    padding: 10px; color: white; border-radius: 3px;"
      ...
      <div class="seat-passenger">
        <div class="assign-panel">
          {#if ticketdetail && !$fetchingTicket}
            <div class="passenger-row" style="color: var(--blue-dark);">
              <span>PassengerName</span> <span>Type</span> <span>-</span>
              <span>SeatNumber</span>
            </div>
            {#each ticketdetail.passengers as p}
              <div class="passenger-row">
                <span>{p.fullName}</span>
                <span>{p.travelerType}</span> <span>—</span>
