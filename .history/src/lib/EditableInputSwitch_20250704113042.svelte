<script lang="ts">
    ...
    // Subscribe to see all settings changes
    settingsStore.subscribe(settings => {
      console.log('Settings updated:', settings);
    });
    
    function handleNotificationsOn() {
      console.log('Notifications enabled!');
    }
    
    function handleNotificationsOff() {
    ...
    <div class="settings-page">
      ...
      <div class="settings-section">
        ...
        <Switch
          ...
          initialValue={true}
          turnOn={handleNotificationsOn}
          turnOff={handleNotificationsOff}
        />
        ...
        <Switch
          ...
          initialValue={false}
          turnOn={handleDarkModeOn}
          turnOff={handleDarkModeOff}
        />
