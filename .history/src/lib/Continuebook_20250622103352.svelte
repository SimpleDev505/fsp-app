              ...
              <div class="details" style="position: relative;">
                ...
                <div class="total" style="position: relative;">
                  <div class="line" style="position: relative;">
                    <span style="position: relative;">Total Fare :</span>
                    <span style="position: relative;"
                      ><del style="position: relative;" class="old">₹9100</del>
                      <span class="new" style="position: relative;">₹6370</span
                      ></span
                    >
                  </div>
                  <div class="line" style="position: relative;">
                    <span style="position: relative;">Discount Applied</span>
                    <span class="discount" style="position: relative;">30%</span
                    >
                  </div>
                </div>
