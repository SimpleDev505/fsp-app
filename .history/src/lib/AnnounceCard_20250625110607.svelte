...
<div class="card">
  ...
  <div class="row time-options">
    <label><input type="checkbox" checked disabled /> Tomorrow</label>
    <label><input type="checkbox" disabled /> +1 Day</label>
    <label><input type="checkbox" disabled /> +2 Day</label>
    <label><input type="checkbox" disabled /> Current Time</label>
    <label><input type="checkbox" disabled /> Custom Time</label>
  </div>
