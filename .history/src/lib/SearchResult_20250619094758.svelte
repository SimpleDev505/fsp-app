...
const flightsearchresults = writable({ flightOffers: [flightSegments], flightDeals: [], aggregation: {}, searchId: "dummy", tripType: "ONEWAY", searchCriteria: { cabinClass: "ECONOMY" } });
