...
<div class="book-flight">
  ...
  <div class="book-flight-summary">
    ...
    <div class="traveller-counter">
      <span
        style=" text-align:center; width:100%; font-size: var(--font-sm); color: var(--blue); font-weight: bold; white-space: nowrap;"
        >TRAVELLER DETAILS
        <br />
        <span
    ...
    <div class="traveller-detail-cnt">
      <div class="traveller-detail">
        ...
        >
        <div
          style="display: flex; flex-direction: row; width: 100%; height: fit-content; justify-content: center; align-items: flex-start;"
        >
