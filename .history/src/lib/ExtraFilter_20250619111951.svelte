<script lang="ts">
  ...
  // Type definitions to match ExtraFilters interface
  ...
  // Configuration arrays for each filter category
  const FILTER_CONFIG = {
    popularFilters: [
  ...
  // Default values that match ExtraFilters interface exactly
  ...
  // State variables - using reactive state with proper type safety
