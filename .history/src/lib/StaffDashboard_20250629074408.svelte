    ...
    {#if $activeSection === "dashboard"}
      ...
      <section class="stats-row">
        ...
        <div class="weather-announcements">
          <section class="weather">
            <div class="weather-header">
              <h2
                style="display: flex; justify-content: flex-start; column-gap: 10px; align-items: center; background-color: var(--blue-dark); width: 100%;
              padding: 10px; color: white; border-radius: 3px;
              font-size: var(--font-sm);"
              >
                WEATHER
        ...
        >
          ...
          >
            <h3 style="color: var(--blue);">GLOBAL ANNOUNCEMENTS</h3>
            <button
              class="refresh-btn"
