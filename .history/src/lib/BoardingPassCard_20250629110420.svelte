        ...
        {#each $pastFlightsData as pflight}
          <div class="pflight">
            ...
            >
              ...
              >
              <span
                style="font-size: 16px; color: var(--blue-dark); font-weight: bold; width: fit-content; height: fit-content;
              padding: 0; margin: 0;">{pflight.bookingDate.split("T")[0]}</span
              >
              <span
                style="font-size: 14px; width: fit-content; height: fit-content;
              padding: 0; margin: 0;">{pflight.ticketNumber}</span
              >
              <span
                style="font-size: 14px; width: fit-content; height: fit-content;
              padding: 0; margin: 0;">{pflight.price.total}</span
              >
            </div>
          </div>
        {/each}
