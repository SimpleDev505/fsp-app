...
<div class="flight-card">
  ...
  <div class="flight-details">
    <div class="tabs">
      <button class="tab active">Flight Information</button>
      <button class="tab">Fare Details & Rules</button>
      <button class="tab">Baggage Information</button>
      <button class="tab">Cancellation & Change Rule</button>
    </div>
                ...
                <td class="time-cell">
                  <div class="departure-info">
                    ...
                    <div class="airport-info">
                      <span class="city"
                        >{leg.departureAirport.cityName} ({leg.departureAirport
                          .code})</span
                      >
                      <span class="date"
                ...
                <td class="duration-cell">
                  <div class="flight-duration">
                    <span class="duration-time"
                      >{formatDuration(Math.floor(leg.totalTime / 60))}</span
                    >
                  </div>
                </td>
