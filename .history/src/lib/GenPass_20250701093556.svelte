...
{#if ticket}
  <div id="boarding-pass">
    ...
    <div
      class="boarding-pass-2"
      style="width: 100%; height: 100%; grid-column: 2; border-left: 2px dashed white;"
    >
      <div class="header">
        <span class="material-symbols-outlined" style="font-size: 32px;">
          plane_contrails
...
<style>
  .boarding-pass-2 {
    background-image: url("data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' stroke='%23333' stroke-width='3' stroke-dasharray='10%2c 35' stroke-dashoffset='0' stroke-linecap='butt'/%3e%3c/svg%3e");
  }
  #boarding-pass {
    display: grid;
