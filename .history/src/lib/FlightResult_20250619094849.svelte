  ...
  {#if isRevealed}
    <div class="details">
      ...
      <div class="baggage-info">
        ...
        {#each offer.segments[0].travellerCheckedLuggage as luggage}
          <p>
            {luggage.luggageAllowance.luggageType}: {luggage.luggageAllowance
              .maxPiece} piece(s), Max Weight: {luggage.luggageAllowance
              .maxTotalWeight}
            {luggage.luggageAllowance.massUnit}
          </p>
        {/each}
        {#each offer.segments[0].travellerCabinLuggage as luggage}
          <p>
            {luggage.luggageAllowance.luggageType}: {luggage.luggageAllowance
              .maxPiece} piece(s), Max Weight: {luggage.luggageAllowance
              .maxWeightPerPiece}
