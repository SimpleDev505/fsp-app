<script lang="ts">
  ...
  let activeSection = $state("account"); // Navigation state
  ...
  <div class="sidebar">
    ...
    <div class="profile-header">
      ...
      <div class="profile-info">
        <h2 class="profile-name">Mr.</h2>
        <p class="join-date">👤 Joined Since 2025</p>
    ...
    <nav class="nav-menu">
      ...
      >
        <span class="nav-icon">💳</span>
        <div class="nav-content">
          <div class="nav-title">EMT Wallet</div>
          <div class="nav-subtitle">
            Check & Manage your added wallet balance
          </div>
        </div>
      </button>
