...
<div class="card">
  ...
  <div class="row time-options">
    <label><input type="checkbox" checked /> Tomorrow</label>
    <label><input type="checkbox" /> +1 Day</label>
    <label><input type="checkbox" /> +2 Day</label>
    <label><input type="checkbox" /> Current Time</label>
    <label><input type="checkbox" /> Custom Time</label>
  </div>
