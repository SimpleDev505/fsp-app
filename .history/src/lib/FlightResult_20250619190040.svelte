...
<script lang="ts">
  ...
  function formatDuration(totalTimeSeconds: number): string {
  ...
  function calculateLayoverTime(leg1: any, leg2: any): string {
    const firstArrival = new Date(leg1.arrivalTime);
    const secondDeparture = new Date(leg2.departureTime);
...
<div class="flight-card">
  <div class="flight-header" onclick={toggleDetails}>
    ...
    <div class="journey-overview">
      ...
      {#if isDetailsVisible}
        <hr style="width:100%; font-weight: bold; color:blue; height:1px;" />
      {/if}
      <div class="journey-info">
        <span class="duration">{formatDuration(totalJourneyTime)}</span>
        <hr style="width:100%; font-weight: bold; color:blue; height:1px;" />
      ...
      <div class="tab-content">
                    ...
                    <td class="duration-cell">
                      <div class="flight-duration">
                        <span class="duration-time"
                          >{formatDuration(leg.totalTime)}</span
                        >
                      </div>
                    </td>
        ...
        {:else if activeTab === "fare-details"}
          ...
          <div class="tab-content-section">
            ...
            {#if flightOffer.brandedFareInfo}
              <div class="fare-rules">
                <h4>Fare Type: {flightOffer.brandedFareInfo.fareName}</h4>
                  ...
                  {#each flightOffer.brandedFareInfo.features as feature}
                    <div class="feature-item">
                      ...
                      <span
                        ...
                        class:included={feature.availability === "INCLUDED"}
                      >
                ...
                {#each flightOffer.fareRules as rule}
                  {#each rule.availablePolicies as policy}
                    <div class="rule-section">
                      ...
                      <p>Fee: {formatPrice(policy.priceBreakdown.total)}</p>
                    </div>
                  {/each}
                {/each}
              {:else}
                <div class="rule-section">
                  ...
                  <ul>
                    ...
                    <li>
                      2-24 hours before departure: ₹3,000 + Airline charges
                    </li>
                    <li>
