        ...
        {#if activeTab === "info"}
          {#each flight.itineraries[0].segments as seg}
            <div class="info-row">
              <span class="material-symbols-outlined">flight_takeoff</span>
              <strong
                style="width: fit-content; height: fit-content; display: flex; flex-direction: row;justify-content:center;align-items:center;"
                >{seg.departure.iataCode}</strong
              >
