        ...
        <button id="signup_login-link" onclick={navClicked}>
          ...
          {:else}
            ...
            <div class="login-detail">
              <p>
                <span class="login-detail-c">Name:</span>{logindetail?.username}
              ...
              <p>
                <span class="login-detail-c">Email:</span>
                {logindetail?.email}
              </p>
              <p>
                <span class="login-detail-c">Phone:</span>
                {logindetail?.phone}
              </p>
              <p>
                <span class="login-detail-c">User Type:</span>
                {logindetail?.user_type}
              </p>
            </div>
          {/if}
        </button>
