        ...
        {#if $profilePhoto}
          ...
          {#if showprofile_action}
            <div
              ...
              style="pointer-events: none; display: flex; justify-content: center; align-items: center; background-color: rgba(255,255,255,.3); position: absolute;"
            >
              <span
  ...
  <div class="main-content">
    ...
    <div class="stats-cards">
      ...
      <div class="stat-card flights">
        <div class="stat-bg">
          <img
            src="src/assets/img/profile/visited.jpg"
            alt="visited"
