    ...
    <div class="traveller-counter">
      <span
        ...
        >TRAVELLER DETAILS <span
          style=" text-align:center; width:100%; font-size: var(--font-s); color: var(--grey-light); font-weight: bold;"
          >Adult{travellercount.adult}.Children{travellercount.children}.Infants{travellercount.infant}</span
        ></span
      >
