...
<div class="flight-card">
  ...
  <div class="tab-content">
      ...
      {#if flight.itineraries}
        <table>
          <tbody>
            <tr
              ><th>From</th><td
                >{flight.itineraries[0].segments[0].departure.iataCode}</td
              ></tr
            >
            <tr
              ><th>To</th><td
                >{flight.itineraries[0].segments.at(-1).arrival.iataCode}</td
              ></tr
            >
    ...
    {:else if activeTab === "fare"}
      {#if fareRules.length}
        <table>
          <thead><tr><th>Rule</th><th>Chargeable</th></tr></thead>
          <tbody>
            {#each fareRules as r}
              <tr
    ...
    {:else if cancelRules.length}
      <table>
        <thead><tr><th>Policy</th><th>Chargeable</th></tr></thead>
        <tbody>
