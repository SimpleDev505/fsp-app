          ...
          {:else}
            ...
            <div class="login-detail">
              <p>
                <span
                  ><span>Name:</span>
                  <span class="login-detail-c">{logindetail?.username}</span>
                </span>
              ...
              <p>
                <span>Email:</span>
                <span class="login-detail-c">{logindetail?.email}</span>
              </p>
              <p>
                <span>Phone:</span>
                <span class="login-detail-c">{logindetail?.phone}</span>
              </p>
              <p>
                <span>User Type:</span>
                <span class="login-detail-c">{logindetail?.user_type}</span>
              </p>
            </div>
          {/if}
        </button>
