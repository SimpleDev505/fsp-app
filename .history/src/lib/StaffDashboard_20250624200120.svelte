...
<div class="dashboard">
  <aside class="sidebar">
    <button id="dash-btn" onclick={() => activeSection.set("dashboard")}
      >DashBoard</button
    >
    <button id="board-btn" onclick={() => activeSection.set("boarding")}
      >Boarding Pass</button
    >
    <button id="ann-btn" onclick={() => activeSection.set("announcements")}
      >Announcements</button
    >
    <button id="sch-btn" onclick={() => activeSection.set("scheduling")}
      >Scheduling</button
    >
  </aside>
