<script lang="ts">
  ...
  //       "New York, USA": "NYC",
  //     };
  //     const originCode = iataMap[timing.from] || "MAD";
  //     const destCode = iataMap[timing.to] || "NYC";
  ...
  //       Dec: "12",
  //     };
  //     const [day, mon, year] = timing.dep.split("'");
  //     const dateISO = `20${year}-${months[mon as keyof typeof months]}-${day.padStart(2, "0")}`;
  ...
  //     console.log("Flight offers:", offerRes.data);
  ...
  //     FlightSearchResults.set(offerRes.data);
