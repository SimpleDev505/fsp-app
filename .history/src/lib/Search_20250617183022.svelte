  ...
  <div class="search-box">
    ...
    <div class="filters-2">
      {#if SelectedTripType === "One Way"}
        <SearchDropDownFiltered index={0} Title="From" items={airports}
        ></SearchDropDownFiltered>
        <SearchDropDownFiltered index={1} Title="To" items={airports}
        ></SearchDropDownFiltered>
        ...
        <div class="search-multi">
          {#each Array(Math.max(1, AddedFlightTrips)) as _, index}
            <div class="search-multi-cnt">
              <SearchDropDownFiltered Title="From" items={airports} />
              <SearchDropDownFiltered Title="To" items={airports} />
