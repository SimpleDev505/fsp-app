...
<div class="book-flight">
  ...
  <div class="book-flight-summary">
    ...
    <div class="traveller-counter">
      ...
      >
      <button
        style="background-color: var(--blue); border: none ; font-weight: bold; color: white; padding: 5px;
        border-radius: 4px; cursor: pointer;"
        onmouseover={() =>
          ((this as HTMLButtonElement).style.backgroundColor =
            "var(--blue-dark)")}>Apply</button
      >
      <div
        class="counter-btns"
    ...
    <div class="traveller-detail-cnt">
      <div class="traveller-detail">
        ...
        <input placeholder="Phone Number" type="tel" bind:value={P_Number} />
      </div>
