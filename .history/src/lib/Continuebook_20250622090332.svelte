    ...
    {#if Applied_TravelledAmount}
      <div class="traveller-detail-cnt">
        ...
        {:else if Continuebook_stage === "Baggage Data"}
          <div
            style="width: 100%; padding: 15px; display: flex; justify-content: center; align-items: center; outline: 2px solid var(--grey-light);
            color:var(--blue); font-weight: bold;"
          >
            <span>Continue Booking To Baggage Details</span>
          </div>
        {/if}
      </div>
    {/if}
