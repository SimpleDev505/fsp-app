...
<div class="boarding-cnt-wrap">
  {#if $GenerateBoardingPass_State === "Assignment"}
    <div class="boarding-cnt" bind:this={boardingpass_cnt}>
      <div class="ticket-search">
        ...
        <button
          style=" background-color: white; background-color: #f8f9fa; color: var(--blue-dark); margin: -17px; border: 2px solid var(--grey-light);
          padding: 6px; display: flex; justify-content: flex-start; align-items: center; width: fit-content; height: fit-content;"
          class="refresh-btn"
      ...
      <h4
        style="background-color: var(--blue-dark); width: 100%;
     padding: 10px; color: white; border-radius: 3px; white-space: nowrap; display: flex; justify-content: flex-start; align-items: center; column-gap: 10px;"
      >
        Seat Map <button
          style=" background-color: white; background-color: #f8f9fa; color: var(--blue-dark);border: 2px solid var(--grey-light);
        padding: 6px; display: flex; justify-content: flex-start; align-items: center; width: fit-content; height: fit-content;"
          class="refresh-btn"
          onclick={() => {
            seatAssignments = {};
  ...
  {:else if $GenerateBoardingPass_State === "Loading Pass"}
    <div
      style="grid-column: 1; width: 100%; height: 100%; max-width: 900px;
    width: 900px; display: flex; flex-direction: column; align-items: center; justify-content: center;"
    >
      <p style="font-size: 24px;">Processing Ticket Details...</p>
      <span style="font-size: 16px;">StandBy</span>
      <DataLoader infinite duration={800} height={60} width={60} strokeWidth={8}
      ></DataLoader>
    </div>
          ...
          onclick={() => {
            if (
              ...
              if (res != true) {
                ...
                assgn_err.message = "Pdf Save Success! Redirecting...";
                assgn_err.type = "SUCCESS";
                setTimeout(() => {
                  assgn_err.message = null;
                  $GenerateBoardingPass_State = "Assignment";
