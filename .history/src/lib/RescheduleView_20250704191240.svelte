<script lang="ts">
  ...
  import Notifier from "./Notifier.svelte"; // Adjust path as needed
  import type { FlightOffer, ScheduledFlight } from "./types"; // Adjust path as needed
  import { SelectedDate } from "./stores"; // Adjust path as needed
