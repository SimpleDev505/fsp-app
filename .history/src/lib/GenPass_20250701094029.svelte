...
<style>
  .boarding-pass-2 {
    background-image: url("data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' stroke='%23C7C7C7FF' stroke-width='3' stroke-dasharray='10%2c 35' stroke-dashoffset='0' stroke-linecap='butt'/%3e%3c/svg%3e");
  }
  #boarding-pass {
    display: grid;
