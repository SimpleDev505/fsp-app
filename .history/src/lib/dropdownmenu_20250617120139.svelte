...
<div
  class="dropdown-menu"
  style="position: absolute; top: {rightpx}px;  left: {leftpx}px; background-color: transparent; color: #d4d4d4; border: 1px solid #3c3c3c; border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.3); z-index: 1000;"
>
  <button
